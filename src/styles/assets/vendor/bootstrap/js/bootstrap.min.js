  ...
  var r;
      ...
      (k = (function() {
        ...
        return (
          (t.toggle = function() {
            var t = !0;
              var e = !0;
              var n = m(this._element).closest(b)[0]
            if (n) {
      ...
      ($ = (function() {
        ...
        return (
          ...
          (t._getItemByDirection = function(t, e) {
            ...
            if (((i && r === 0) || (n && r === s)) && !this._config.wrap)
              return e
          ...
          (t._triggerSlideEvent = function(t, e) {
            var n = this._getItemIndex(t);
              var i = this._getItemIndex(P(this._element).find(Z.ACTIVE_ITEM)[0]);
          ...
          (t._slide = function(t, e) {
            var n;
              ...
              var r;
              var s = this;
              var o = P(this._element).find(Z.ACTIVE_ITEM)[0];
              var a = this._getItemIndex(o);
              var l = e || (o && this._getItemByDirection(t, o));
              var h = this._getItemIndex(l);
          ...
          (s._jQueryInterface = function(i) {
            return this.each(function() {
              var t = P(this).data(j);
                var e = h({}, M, P(this).data())
              typeof i === 'object' && (e = h({}, e, i))
      ...
      (gt = (function() {
        function a(t, e) {
          ...
          for (var n = tt(_t.DATA_TOGGLE), i = 0; i < n.length; i++) {
            var r = n[i];
              var s = Cn.getSelectorFromElement(r)
            s !== null &&
              tt(s).filter(t).length > 0 &&
        ...
        return (
          ...
          (a._jQueryInterface = function(i) {
            return this.each(function() {
              var t = tt(this);
                var e = t.data(nt);
                var n = h({}, st, t.data(), typeof i === 'object' && i ? i : {})
              if (
      ...
      (Qt = (function() {
        ...
        return (
          (t.toggle = function() {
            if (!this._element.disabled && !mt(this._element).hasClass(At)) {
              var t = l._getParentFromElement(this._element);
                var e = mt(this._menu).hasClass(Dt)
              if ((l._clearMenus(), !e)) {
                var n = { relatedTarget: this._element };
                  var i = mt.Event(It.SHOW, n)
          ...
          (l._getParentFromElement = function(t) {
            var e;
              var n = Cn.getSelectorFromElement(t)
    ...
    var wn =
      ...
      (se = (function() {
        ...
        return (
          ...
          (t._showElement = function(t) {
            var e = this;
              var n = Bt(this._element).hasClass(ne)
          ...
          (t._enforceFocus = function() {
            ...
            Bt(document)
              ...
              .on(Zt.FOCUSIN, function(t) {
                document !== t.target &&
                  e._element !== t.target &&
                  Bt(e._element).has(t.target).length === 0 &&
                  e._element.focus()
              })
          }),
          ...
          (t._showBackdrop = function(t) {
            var e = this;
              var n = Bt(this._element).hasClass(ne) ? ne : ''
          ...
          (t._setScrollbar = function() {
            ...
            if (this._isBodyOverflowing) {
              ...
              var t = document.body.style.paddingRight;
                var e = Bt(document.body).css('padding-right')
              Bt(document.body)
      ...
      Bt(document).on(Zt.CLICK_DATA_API, re.DATA_TOGGLE, function(t) {
        var e;
          var n = this;
          var i = Cn.getSelectorFromElement(this)
        i && (e = Bt(i)[0])
    ...
    var Nn =
      ...
      (Se = (function() {
        ...
        return (
            ...
            if (this._isEnabled)
              if (t) {
                var e = this.constructor.DATA_KEY;
                  var n = oe(t.currentTarget).data(e)
                n ||
          ...
          (t.show = function() {
            var e = this
            if (oe(this.element).css('display') === 'none')
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              var i = this.getTipElement();
                var r = Cn.getUID(this.constructor.NAME)
              i.setAttribute('id', r),
          ...
          (t.hide = function(t) {
            var e = this;
              ...
              var i = oe.Event(this.constructor.Event.HIDE);
              var r = function() {
                e._hoverState !== me &&
                  n.parentNode &&
          ...
          (t._enter = function(t, e) {
            ...
            ;(e = e || oe(t.currentTarget).data(n)) ||
              ...
              t && (e._activeTrigger[t.type === 'focusin' ? Ae : Ie] = !0),
          ...
          (t._leave = function(t, e) {
            ...
            ;(e = e || oe(t.currentTarget).data(n)) ||
              ...
              oe(t.currentTarget).data(n, e)),
              t && (e._activeTrigger[t.type === 'focusout' ? Ae : Ie] = !1),
    ...
    var kn =
      ...
      (nn = (function() {
        ...
        return (
          (t.refresh = function() {
            var e = this;
              var t = this._scrollElement === this._scrollElement.window ? tn : en;
              var r = this._config.method === 'auto' ? t : this._config.method;
              var s = r === en ? this._getScrollTop() : 0
            ;(this._offsets = []),
              (this._targets = []),
          ...
          (t._getConfig = function(t) {
            if (
              typeof (t = h({}, qe, typeof t === 'object' && t ? t : {})).target !==
              'string'
            ) {
        ...
        return (
          (t.show = function() {
            ...
            if (
              ...
              var t;
                var i;
                var e = rn(this._element).closest(gn)[0];
                var r = Cn.getSelectorFromElement(this._element)
              if (e) {
                var s = e.nodeName === 'UL' ? pn : mn
                i = (i = rn.makeArray(rn(e).find(s)))[i.length - 1]
              }
              var o = rn.Event(ln.HIDE, { relatedTarget: this._element });
                var a = rn.Event(ln.SHOW, { relatedTarget: i })
              if (
                (i && rn(i).trigger(o),
                ...
                var l = function() {
                  var t = rn.Event(ln.HIDDEN, { relatedTarget: n._element });
                    var e = rn.Event(ln.SHOWN, { relatedTarget: i })
