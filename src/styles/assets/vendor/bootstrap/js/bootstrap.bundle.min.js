...
!(function(t, e) {
        ...
        (N = (function() {
          ...
          return (
            (t.toggle = function() {
              var t = !0;
                var e = !0;
                var n = g(this._element).closest(I)[0]
              if (n) {
          ...
          return (
            ...
            (t._triggerSlideEvent = function(t, e) {
              var n = this._getItemIndex(t);
                var i = this._getItemIndex(k(this._element).find(J.ACTIVE_ITEM)[0]);
                var r = k.Event(K.SLIDE, {
                  relatedTarget: t,
                  direction: e,
                  from: i,
                  to: n,
        ...
        (pt = (function() {
          function a(t, e) {
            ...
            for (var n = $(dt.DATA_TOGGLE), i = 0; i < n.length; i++) {
              var r = n[i];
                var o = gt.getSelectorFromElement(r)
              o !== null &&
                $(o).filter(t).length > 0 &&
          ...
          return (
            ...
            (a._jQueryInterface = function(i) {
              return this.each(function() {
                var t = $(this);
                  var e = t.data(et);
                  var n = c({}, rt, t.data(), typeof i === 'object' && i ? i : {})
                if (
  ...
  var Ot = yt && !(!window.MSInputMethodContext || !document.documentMode);
    var Nt = yt && /MSIE 10/.test(navigator.userAgent)
  function kt(t) {
  ...
  function Ht() {
    var t = document.body;
      ...
      var n = kt(10) && getComputedStyle(e)
  ...
  function Vt(t) {
    ...
    var r = {
      ...
      var o = t.nodeName === 'HTML' ? Ht() : {};
      var s = o.width || t.clientWidth || r.right - r.left;
      var a = o.height || t.clientHeight || r.bottom - r.top;
      var l = t.offsetWidth - s;
      var c = t.offsetHeight - a
    if (l || c) {
      var f = Dt(t)
  ...
  function Qt(t, e) {
    var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
      var i = kt(10);
      var r = e.nodeName === 'HTML';
      var o = Vt(t);
      var s = Vt(e);
      var a = St(t);
      var l = Dt(e);
      var c = parseFloat(l.borderTopWidth, 10);
      var f = parseFloat(l.borderLeftWidth, 10)
    n &&
      e.nodeName === 'HTML' &&
    ...
    if (((h.marginTop = 0), (h.marginLeft = 0), !i && r)) {
      var u = parseFloat(l.marginTop, 10);
        var d = parseFloat(l.marginLeft, 10)
      ;(h.top -= c - u),
        (h.bottom -= c - u),
        (h.left -= f - d),
        (h.right -= f - d),
  ...
  function Yt(t) {
    ...
    for (var e = t.parentElement; e && Dt(e, 'transform') === 'none'; )
      e = e.parentElement
  ...
  function qt(t, e, i, n, r) {
    ...
    var s = Gt(i, n, o, r);
      ...
      var f = c.length > 0 ? c[0].key : l[0].key;
      var h = t.split('-')[1]
    return f + (h ? '-' + h : '')
  }
  function zt(t, e, n) {
  ...
  function Xt(t) {
    var e = getComputedStyle(t);
      var n = parseFloat(e.marginTop) + parseFloat(e.marginBottom);
      var i = parseFloat(e.marginLeft) + parseFloat(e.marginRight)
    ...
    return (
      (function t(e, n, i, r) {
        var o = e.nodeName === 'BODY';
          var s = o ? e.ownerDocument.defaultView : e
        ...
        arrow: {
          ...
          fn: function(t, e) {
            ...
            var r = t.placement.split('-')[0];
              ...
              var s = o.popper;
              var a = o.reference;
              var l = ['left', 'right'].indexOf(r) !== -1;
              var c = l ? 'height' : 'width';
              var f = l ? 'Top' : 'Left';
              var h = f.toLowerCase();
              var u = l ? 'left' : 'top';
              var d = l ? 'bottom' : 'right';
              var p = Xt(i)[c]
            a[d] - p < s[h] && (t.offsets.popper[h] -= s[h] - (a[d] - p)),
              a[h] + p > s[d] && (t.offsets.popper[h] += a[h] + p - s[d]),
              (t.offsets.popper = Kt(t.offsets.popper))
            var g = a[h] + a[c] / 2 - p / 2;
              var m = Dt(t.instance.popper);
              var _ = parseFloat(m['margin' + f], 10);
              var v = parseFloat(m['border' + f + 'Width'], 10);
              var E = g - t.offsets.popper[h] - _ - v
            return (
        ...
        flip: {
          ...
          fn: function(p, g) {
            ...
            var m = Gt(
              ...
              var _ = p.placement.split('-')[0];
              var v = Jt(_);
              var E = p.placement.split('-')[1] || '';
              var y = []
            switch (g.behavior) {
              case ue.FLIP:
                y = [_, v]
            ...
            return (
              y.forEach(function(t, e) {
                ...
                var n;
                  ...
                  var a = o(i.left) < o(m.left);
                  var l = o(i.right) > o(m.right);
                  var c = o(i.top) < o(m.top);
                  var f = o(i.bottom) > o(m.bottom);
                  var h =
                    (_ === 'left' && a) ||
                    (_ === 'right' && l) ||
                    (_ === 'top' && c) ||
                    (_ === 'bottom' && f);
                  var u = ['top', 'bottom'].indexOf(_) !== -1;
                  var d =
                    !!g.flipVariations &&
                    ((u && E === 'start' && a) ||
                      (u && E === 'end' && l) ||
        ...
        inner: {
          ...
          fn: function(t) {
            var e = t.placement;
              ...
              var r = i.popper;
              var o = i.reference;
              var s = ['left', 'right'].indexOf(n) !== -1;
              var a = ['top', 'left'].indexOf(n) === -1
            return (
              (r[s ? 'left' : 'top'] =
        ...
        hide: {
          ...
          fn: function(t) {
            ...
            var e = t.offsets.reference;
              var n = $t(t.instance.modifiers, function(t) {
        ...
        computeStyle: {
          ...
          fn: function(t, e) {
            var n = e.x;
              ...
              var o = $t(t.instance.modifiers, function(t) {
            ...
            var s = void 0 !== o ? o : e.gpuAcceleration;
              var a = Vt(Lt(t.instance.popper));
              var l = { position: r.position };
              var c = {
      ...
      (Ve = (function() {
        ...
        return (
          (t.toggle = function() {
            if (!this._element.disabled && !me(this._element).hasClass(we)) {
              var t = l._getParentFromElement(this._element);
                var e = me(this._menu).hasClass(Ie)
              if ((l._clearMenus(), !e)) {
                var n = { relatedTarget: this._element };
                  var i = me.Event(Ce.SHOW, n)
                if ((me(t).trigger(i), !i.isDefaultPrevented())) {
                  ...
                  'ontouchstart' in document.documentElement &&
                    ...
                    me(document.body)
                      .children()
                      .on('mouseover', null, me.noop),
                    this._element.focus(),
                    this._element.setAttribute('aria-expanded', !0),
                    me(this._menu).toggleClass(Ie),
                    me(t)
                      .toggleClass(Ie)
                      .trigger(me.Event(Ce.SHOWN, n))
                }
              }
            }
          }),
            ...
            if (!t || (t.which !== 3 && (t.type !== 'keyup' || t.which === 9)))
              for (var e = me.makeArray(me(ke)), n = 0; n < e.length; n++) {
                var i = l._getParentFromElement(e[n]);
                  var r = me(e[n]).data(ve);
                  var o = { relatedTarget: e[n] }
                if (r) {
                  var s = r._menu
                  if (
                    me(i).hasClass(Ie) &&
          ...
          (l._getParentFromElement = function(t) {
            var e;
              var n = gt.getSelectorFromElement(t)
      ...
      (sn = (function() {
        ...
        return (
          ...
          (t._showElement = function(t) {
            var e = this;
              var n = Qe(this._element).hasClass(nn)
          ...
          (t._showBackdrop = function(t) {
            var e = this;
              var n = Qe(this._element).hasClass(nn) ? nn : ''
          ...
          (t._setScrollbar = function() {
            ...
            if (this._isBodyOverflowing) {
              ...
              var t = document.body.style.paddingRight;
                var e = Qe(document.body).css('padding-right')
              Qe(document.body)
    ...
    var wi =
      ...
      (Sn = (function() {
        ...
        return (
            ...
            if (this._isEnabled)
              if (t) {
                var e = this.constructor.DATA_KEY;
                  var n = an(t.currentTarget).data(e)
                n ||
          ...
          (t.show = function() {
            var e = this
            if (an(this.element).css('display') === 'none')
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              var i = this.getTipElement();
                var r = gt.getUID(this.constructor.NAME)
              i.setAttribute('id', r),
          ...
          (t.hide = function(t) {
            var e = this;
              ...
              var i = an.Event(this.constructor.Event.HIDE);
              var r = function() {
                e._hoverState !== _n &&
                  n.parentNode &&
    ...
    var Di =
      ...
      (ii = (function() {
        ...
        return (
          (t.refresh = function() {
            var e = this;
              var t = this._scrollElement === this._scrollElement.window ? ei : ni;
              var r = this._config.method === 'auto' ? t : this._config.method;
              var o = r === ni ? this._getScrollTop() : 0
            ;(this._offsets = []),
              (this._targets = []),
            ...
            n.hasClass(Zn)
              ...
              : (n.addClass($n),
                ...
                n
                  ...
                  .addClass($n)),
              Vn(this._scrollElement).trigger(Jn.ACTIVATE, { relatedTarget: e })
          }),
          (t._clear = function() {
            Vn(this._selector)
              .filter(ti.ACTIVE)
        ...
        return (
          (t.show = function() {
            ...
            if (
              ...
              var t;
                var i;
                var e = ri(this._element).closest(gi)[0];
                var r = gt.getSelectorFromElement(this._element)
              if (e) {
                var o = e.nodeName === 'UL' ? _i : mi
                i = (i = ri.makeArray(ri(e).find(o)))[i.length - 1]
              }
              var s = ri.Event(li.HIDE, { relatedTarget: this._element });
                var a = ri.Event(li.SHOW, { relatedTarget: i })
              if (
                (i && ri(i).trigger(s),
                ...
                var l = function() {
                  var t = ri.Event(li.HIDDEN, { relatedTarget: n._element });
                    var e = ri.Event(li.SHOWN, { relatedTarget: i })
